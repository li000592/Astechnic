    ...
    return (
        <div id="about-video-container">
            ...
            <div className="about-main-content">
                <h1 className="about-video-title animate__animated animate__fadeInDown blue">DIGITAL<br />
                    SOLUTIONS,</h1>
                <h1 className="about-video-title animate__animated animate__fadeInDown">REAL-WORLD<br />RESULTS.</h1>
            </div>
